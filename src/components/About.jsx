        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12  ">
          ...
          <div className="flex-1">
            <p className="text-lg mb-8">
              I am a passionate frontend developer with focus on building modern
              and responsibe web application. With a strong foundation of
              frontend technologies, I strive to create seamless and efficient
              user experience.
            </p>
